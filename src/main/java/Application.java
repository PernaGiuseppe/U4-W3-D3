...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Evento event1 = new Evento("matrimonio", 2025, 10, 5, "unione fra due persone che si amano", EventType.PRIVATO, 250);
        Evento event2 = new Evento("concerto", 2022, 8, 1, "musica ad alto volume in piazza", EventType.PUBBLICO, 800);
        Evento event3 = new Evento("sagra", 2023, 6, 30, "sagra della castagna dell'Etna", EventType.PUBBLICO, 900);
